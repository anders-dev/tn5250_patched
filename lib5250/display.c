...
void tn5250_display_set_cursor_next_progression_field(Tn5250Display* This,
                                                      int nextfield);
void tn5250_display_set_cursor_prev_progression_field(Tn5250Display* This,
                                                      int currentfield);
 ...
 *    display buffers.
 *****/
static void tn5250_display_add_dbuffer(Tn5250Display* This,
                                       Tn5250DBuffer* dbuffer) {
...
void tn5250_display_beep(Tn5250Display* This) {
    ...
    if ((cmd = tn5250_config_get(This->config, "beep_command")) != NULL) {
        ...
        if (ec == -1) {
            TN5250_LOG(
                ("system() for beep command failed: %s\n", strerror(errno)));
        }
        else if (ec != 0) {
...
Tn5250Field* tn5250_display_current_field(Tn5250Display* This) {
    return tn5250_display_field_at(This, tn5250_display_cursor_y(This),
...
void tn5250_display_set_cursor_next_field(Tn5250Display* This) {
    ...
    if ((currentfield != NULL) && (currentfield->nextfieldprogressionid != 0)) {
        tn5250_display_set_cursor_next_progression_field(
            This, currentfield->nextfieldprogressionid);
    }
    else {
 ...
 *****/
void tn5250_display_set_cursor_next_logical_field(Tn5250Display* This) {
    Tn5250Field* currentfield = tn5250_display_current_field(This);
 ...
 *    position if there are no non-bypass fields.
 *****/
void tn5250_display_set_cursor_prev_logical_field(Tn5250Display* This) {
...
void tn5250_display_make_wtd_data(Tn5250Display* This, Tn5250Buffer* buf,
    ...
    /*
       ...
       restored
     */
    tn5250_wtd_context_set_ic(ctx, tn5250_display_cursor_y(This) + 1,
    ...
    ***/
    ...
    if ((tn5250_display_indicators(This) & TN5250_DISPLAY_IND_INSERT) != 0) {
        ...
        if (tn5250_field_is_wordwrap(field)) {
            tn5250_display_wordwrap_insert(
                This, tn5250_char_map_to_remote(This->map, ch),
                tn5250_field_count_right(field, tn5250_display_cursor_y(This),
                                         tn5250_display_cursor_x(This)));
        }
        else {
            tn5250_dbuffer_ins(
                This->display_buffers, field->id,
    ...
    if (end_of_field && !tn5250_field_is_wordwrap(field)) {
        if (tn5250_field_is_fer(field)) {
            ...
            tn5250_display_set_cursor(This, tn5250_field_end_row(field),
 ...
 *****/
void tn5250_display_shift_right(Tn5250Display* This, Tn5250Field* field,
                                unsigned char fill) {
    int n, end;
    unsigned char* ptr;
...
void tn5250_display_do_key(Tn5250Display* This, int key) {
    ...
    case TN5250_KEYSTATE_LOCKED:
        ...
        break;
    case TN5250_KEYSTATE_PREHELP:
        if (key != K_RESET && key != K_HELP && key != K_PRINT &&
            key != K_ATTENTION) {
        ...
        if (key >= K_F1 && key <= K_F24) {
            if ((!tn5250_macro_recfunct(This, key)) &&
                ...
                if (key <= K_F12) {
                    ...
                    tn5250_display_do_aidkey(This, key - K_F1 +
                                                       TN5250_SESSION_AID_F1);
                }
                else {
                    tn5250_display_do_aidkey(This, key - K_F13 +
 ...
 *****/
void tn5250_display_field_pad_and_adjust(Tn5250Display* This,
                                         Tn5250Field* field) {
    Tn5250Field* iter;
    unsigned char* data;
    int i, l;
...
void tn5250_display_kf_backtab(Tn5250Display* This) {
    ...
    if (field == NULL ||
        tn5250_field_count_left(field, tn5250_display_cursor_y(This),
...
void tn5250_display_save_msg_line(Tn5250Display* This) {
    ...
    l = tn5250_dbuffer_msg_line(This->display_buffers);
    memcpy(This->saved_msg_line,
           This->display_buffers->data + tn5250_display_width(This) * l,
 ...
 *****/
void tn5250_display_set_msg_line(Tn5250Display* This,
 ...
 *****/
void tn5250_display_erase_region(Tn5250Display* This, unsigned int startrow,
        ...
        for (i = startrow - 1; i < endrow; i++) {
            if (i == (startrow - 1)) {
                for (j = startcol - 1; j < rightedge; j++) {
                    This->display_buffers
                        ->data[(i * This->display_buffers->w) + j] =
                        tn5250_char_map_to_remote(This->map, ' ');
                }
            }
            else if (i == (endrow - 1)) {
...
void tn5250_display_wordwrap_addch(Tn5250Display* This, unsigned char c) {
    ...
    if (!tn5250_field_is_continued_first(field)) {
        ...
        ptr = ptr + (tn5250_field_length(field->prev) * sizeof(unsigned char));
        memcpy(ptr, &espace, sizeof(unsigned char));
        ptr = ptr + sizeof(unsigned char);
    }
...
void tn5250_display_wordwrap(Tn5250Display* This, unsigned char* text,
    ...
    for (iter = field; iter->entry_id == origentryid; iter = iter->next) {
        ...
        for (j = tn5250_field_start_col(iter); j <= tn5250_field_end_col(iter);
             j++) {
